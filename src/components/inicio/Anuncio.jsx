  ...
  return (
   <>
    ...
    <section className="d-flex flex-column flex-lg-row py-5 h-100 my-5 justify-content-center p-lg-0 px-sm-2 px-4 row m-0">
      ...
      <main className="d-flex col-lg-5 col-12 flex-column justify-content-evenly  align-items-center ms-0 ms-lg-5 mt-5 mt-lg-0"data-aos="flip-right">
        <article className="d-flex w-lg-50 w-100 ms-0 mt-3 mt-0">
            <div className="circle d-flex justify-content-center align-items-center me-lg-5 me-3">
