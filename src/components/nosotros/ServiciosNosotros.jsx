...
const ServiciosNosotros = () => {
  ...
  return (
    <section className="px-lg-5 px-2 pt-5">
      <header className="d-flex align-itenms-center justify-content-center">
        ...
        <div className="my-auto mx-4 w-lg-50 w-75">
      ...
      <main className='mt-5 container-fluid'>
        <div className='row m-0 justify-content-center'>
        {
          services.map((element,index)=>{
            return(
              <section className="shadow col-12 col-lg-5 m-3 p-0" style={{overflow: "hidden", borderRadius:"15px", position:"relative"}} key={index} data-aos="zoom-in-down">
                ...
                <main className='container-mame'>
                  ...
                  <div className='w-lg-25 w-50 container-button d-flex flex-column align-items-center justify-content-center'>
                    <span className='text-dark text-center fs-5 fw-bold mb-4 text-uppercase'>Ver más</span>
                    <Link to={element.url} className='btn-viewService'>
