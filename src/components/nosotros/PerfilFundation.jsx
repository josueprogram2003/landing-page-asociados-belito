  ...
  return (
    <div className="bg-white py-5 row d-flex align-items-center justify-content-center flex-column flex-md-row m-0" >
      ...
      <div className='col-10 col-lg-6 ms-0 ms-lg-5 mt-5 mt-lg-0'>
        ...
        <p className='color-primary fs-5'>De profesión abogada especialista en Derecho Notarial, Derecho Registral, Derecho Inmoviliario y Derecho corporativo, con mas  de 10 años de servicio en diversas notarias , empresas , estudios juridicos, brindando asesoría legal y respaldo jurídico en el ámbito civil, administrativo y conciliatorio.</p>
      </div>
    </div>
  )
}
